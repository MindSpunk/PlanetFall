...
import com.spark.planetfall.game.actors.components.player.classes.LightAssault;
import com.spark.planetfall.game.actors.components.player.classes.PlayerClass;
...
public class Player extends Actor implements Controlled {
    ...
    public Player(SparkGame game) {
        ...
        this.playerClass.equipment = game.weapons;
